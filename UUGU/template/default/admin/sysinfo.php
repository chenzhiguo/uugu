...
#lnmplink {position: absolute; top: 20px; left: 315px; text-align: right; font-weight: bold; color: #06C;}
...
<div id="page">
    <div id="header">
        <h1>系统运行环境参数列表</h1>
        <div id="lnmplink">for <a href="http://www.uugu.org" target="_blank">UUGU</a></div>
    </div>
...
<div id="footer">
&copy; 2011 <a href="http://www.uugu.org" target="_blank">PHP探针</a><br />All Rights Reserved.<br />
